...
export default function ZoomIcon() {
    return (
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.75 15.75H10.5M31.5 31.5L24.771 24.759L31.5 31.5ZM28.5 15.75C28.5 19.1315 27.1567 22.3745 24.7656 24.7656C22.3745 27.1567 19.1315 28.5 15.75 28.5C12.3685 28.5 9.12548 27.1567 6.73439 24.7656C4.3433 22.3745 3 19.1315 3 15.75C3 12.3685 4.3433 9.12548 6.73439 6.73439C9.12548 4.3433 12.3685 3 15.75 3C19.1315 3 22.3745 4.3433 24.7656 6.73439C27.1567 9.12548 28.5 12.3685 28.5 15.75V15.75ZM15.75 10.5V15.75V10.5ZM15.75 15.75V21V15.75ZM15.75 15.75H21H15.75Z" stroke="#FF994E" strokeWidth="2" strokeLinecap="round" />
        </svg>
    )
}
